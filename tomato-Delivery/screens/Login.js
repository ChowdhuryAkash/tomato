    ...
    <View style={styles.main}>
      ...
      <View style={styles.inputs}>
        <View style={styles.input}>
          <AntDesign name="user" size={24} color={emailcolor ? "#4FB548" : "gray"} />
      ...
      <Text>Don't have an account? <Text style={{ color: "#4FB548" }} onPress={() => { navigation.navigate("signup") }}>Sign Up</Text></Text>
      {loading ?
        <Loader />
        : ""}
